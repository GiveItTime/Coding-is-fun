...
public class QuizFragment extends Fragment 
{
   ...
   private int	firstTry = 0;	// Number correct on first Try
   ...
   private OnClickListener guessButtonListener = new OnClickListener() 
   {
      ...
      public void onClick(View v) 
      {
         ...
         // Checks to see if we got correct answer on first try
            if(totalGuesses == correctAnswers){
            	++firstTry;
            }
            else if(totalGuesses > correctAnswers){
            	--totalGuesses;
            }
